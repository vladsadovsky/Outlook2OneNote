...
const CORS_ORIGIN = process.env.EXTSERVICES_CORS_ORIGIN || 'https://localhost:3000';
const GRAPH_AUTHORITY = process.env.GRAPH_AUTHORITY || 'https://login.microsoftonline.com/common';
const OBO_SCOPES = getEnvList('GRAPH_OBO_SCOPES', [
...
const jwksUri = `${GRAPH_AUTHORITY}/discovery/v2.0/keys`;
